...
export default function ProductsClient({
  ...
  // Server provides the initial list, so there is no client loading/error state
  // on first paint. Kept (without setters) so the skeleton/error JSX is preserved.
  ...
  // WHY: Each ?collection= navigation re-renders the Server Component, which
  // passes a fresh initialProducts prop. Mirror that into local state so
  // client-side collection switching stays in sync (no client API fetch needed).
  useEffect(() => {
